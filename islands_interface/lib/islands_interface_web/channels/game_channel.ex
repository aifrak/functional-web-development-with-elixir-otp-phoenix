defmodule IslandsInterfaceWeb.GameChannel do
  ...
  def handle_in("position_island", payload, socket) do
    ...
    # HACK: Preload atoms. (custom)
    # The idea was to do input validations with "String.to_existing_atom".
    # It should be avoided and values should be explicitly checked:
    # https://elixirforum.com/t/loading-of-atoms-which-have-been-defined-in-a-modules-types/29384
